  ...
  return (
    <header
      className={cn(
        ...
        isSticky
          ? 'sticky-header fixed left-0 top-0 w-full animate-fadeInDown bg-white/90 backdrop-blur-md [box-shadow:0px_0px_15px_10px_rgba(42,223,25,.1)] dark:bg-accent-900/90'
          : 'absolute'
      )}
    >
      <Container>
