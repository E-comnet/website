...
const offCanvasProps: IOffCanvas = {
  description:
  'Founded in 2017 in Yaoundé, Cameroon, Ecomnet is a forward-thinking IT services company dedicated to driving digital transformation in the region. Born from a project by the NGO MAPUBI e.V., we aim to bridge the technological gap by providing innovative solutions that empower businesses and individuals. Our focus is on offering reliable, high-quality IT services that meet the unique needs of our clients, helping them thrive in the rapidly evolving digital landscape.',
  contactInfo: {
