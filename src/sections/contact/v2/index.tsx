...
export const contactSectionData: ContactSectionProps = {
  ...
  contactInfo: {
    sectionHeading: {
      title: 'Get in touch ',
      description:
        "Have a project or question in mind? We're here to help you achieve your goals and drive innovation. Let's start a conversation and explore how we can work together to bring your vision to life.",
    },
