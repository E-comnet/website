        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-ad.png'}
                alt="advertising image main"
                width={850}
                height={512}
              />
            ...
            <p>
              In an age where attention spans are dwindling, capturing and retaining the interest of your audience is a significant challenge. High-quality multimedia
              content—such as videos, animations, and audio ads—has proven to be one of the most effective ways to engage consumers. It allows you to tell your brand’s
              story in a way that is both visually appealing and emotionally resonant. Whether you’re launching a new product,
              running a promotional campaign, or simply looking to increase brand awareness, multimedia content can make your message more compelling and memorable.
            </p>
            <p>
              Advertising, when done right, ensures that your multimedia content reaches the right audience. By leveraging targeted advertising strategies, businesses
            ...
            <div className="mt-2.5">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    Our team at Ecomnet excels at blending creativity with strategy. From creating visually striking multimedia content to narrating your
                    brand's story in an engaging way, we ensure that your message stands out in a crowded marketplace.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    The most powerful multimedia content is wasted if it doesn’t reach the right audience. Ecomnet specializes in designing targeted campaigns
                    that connect your brand with the people most likely to convert, helping you optimize marketing spend while maximizing impact.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    By creating content that resonates emotionally with your target audience, Ecomnet helps you build deeper connections with your customers.
                    High engagement often translates into brand loyalty, repeat business, and more advocacy for your brand.
                  </p>
                </div>
              </div>
            </div>
