        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-call.png'}
                alt="call center image main"
                width={850}
                height={512}
              />
            ...
            <p>
              Delivering exceptional customer service has become a key differentiator for businesses today. A reliable and efficient call center
              acts as the front line in managing customer inquiries, resolving issues, and providing a seamless communication experience.
              With customer expectations at an all-time high, businesses cannot afford to have anything less than top-tier customer support.
            </p>
            <p>
              your business's specific needs. From handling large volumes of customer interactions to offering multi-channel support, our call
              center services ensure that your customers receive prompt, personalized, and professional service at every touchpoint.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    At Ecomnet, we don’t offer one-size-fits-all call center services. Instead, we take the time to understand your specific business needs,
                    and then tailor our solutions to help you manage customer interactions more effectively.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    We specialize in optimizing call center operations to ensure faster response times, better customer satisfaction, and fewer escalations.
                    Ecomnet’s processes are designed to make your call center both efficient and scalable.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    We offer round-the-clock call center services to meet the demands of your customers, no matter where they are or what time they need support.
                    Your customers will never feel neglected with our consistent and reliable service.
                  </p>
                </div>
              </div>
            </div>
