...
const services: LinkProps[] = [
  ...
  {
    label: 'Testing and Communication Campaigns',
        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-dev.png'}
                alt="dev image main"
                width={850}
                height={512}
              />
            ...
            <p>
              In today's competitive digital landscape, having a robust online
              presence is no longer just an advantage—it's a necessity.
              For businesses, a well-designed website or app serves as the primary
              interface between them and their customers. It's where potential
              clients first interact with your brand, form their initial impressions,
              and decide whether to engage further. Without a professional and user-friendly
              platform, businesses risk losing potential customers to
              competitors who have invested in quality digital experiences.
            </p>
            <p>
              Moreover, as consumer behavior continues to shift towards online interactions,
              the demand for seamless, mobile-friendly experiences has skyrocketed. Whether it’s
              browsing products, booking services, or simply gathering information, users expect a
              fast, intuitive, and visually appealing interface. A poorly designed website or app can
              frustrate users, leading to higher bounce rates and lost revenue.
            </p>
            ...
            <div className="mt-2.5">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    At Ecomnet, we don’t believe in one-size-fits-all solutions. Our approach starts with understanding your brand’s
                    identity and unique goals, then crafting a website or app that truly reflects those values. From color schemes to
                    interface elements, every part of the design is customized to match your business vision.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    The success of any website or app hinges on its user experience. We prioritize creating intuitive, responsive designs that make navigation
                    effortless and enjoyable for your users. This leads to higher engagement, better conversion rates, and more satisfied customers.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Ecomnet ensures that the websites and apps we build work seamlessly with your existing systems, minimizing downtime and ensuring smooth operations.
                    Whether it’s CRM integration or payment gateway setup, we cover all the bases to ensure your new platform is up and running efficiently.
                  </p>
                </div>
              </div>
            </div>
