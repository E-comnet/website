        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-eq.png'}
                alt="equipment image main"
                width={850}
                height={512}
              />
            ...
            <p>
              In today's technologically driven world, the right equipment can make all the difference in your
              business’s efficiency, security, and overall success. From IT hardware that ensures smooth daily operations
              to advanced security systems that protect your assets, having the right tools is essential. Additionally, high-quality
              multimedia equipment can enhance your business's ability to communicate effectively, both internally and externally.
            </p>
            <p>
              Investing in the right equipment not only improves your business operations but also positions you to stay competitive in
              a rapidly evolving market. Without up-to-date technology, businesses risk falling behind, facing increased security threats,
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    We understand that no two businesses have the same requirements when it comes to technology. Ecomnet provides personalized recommendations,
                    ensuring that the IT and security systems you invest in are the perfect fit for your specific operational needs.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Technology evolves rapidly, and staying ahead of the curve is crucial. Ecomnet ensures that you receive state-of-the-art equipment that
                    not only meets your current needs but also scales with your business.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Purchasing equipment is just the first step. Ecomnet offers ongoing support to ensure that your systems run smoothly,
                    minimizing downtime and ensuring that your business operates at peak efficiency
                  </p>
                </div>
              </div>
            </div>
