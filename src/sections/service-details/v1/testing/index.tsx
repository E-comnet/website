        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-test.png'}
                alt="testing image main"
                width={850}
                height={512}
              />
            ...
            <p>
              Launching a new product or service is a complex process that requires careful planning and execution. One of the key elements
              of a successful launch is thorough testing. This involves not only technical testing to ensure that your product works as
              intended but also market testing to gauge consumer interest and identify potential challenges. Without proper testing, businesses
              risk launching products that are flawed or poorly received, which can result in costly setbacks.
            </p>
            <p>
              Equally important is the communication campaign surrounding the launch. It’s not enough to have a great product—you also need to
              make sure that your target audience knows about it and understands its value. A well-crafted communication campaign can create buzz,
              generate interest, and drive sales, while a poorly executed one can leave your product unnoticed.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    Before launching any product or service, Ecomnet conducts thorough testing to ensure everything works flawlessly. This includes technical assessments
                    as well as market testing to predict user reception. By identifying issues early, we help you avoid costly post-launch fixes.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Our communication campaigns are designed with precision, ensuring your message reaches the right audience at the right time. We help craft
                    compelling narratives that resonate with potential customers and encourage them to take action.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    With years of experience and a track record of success, Ecomnet knows what works and what doesn’t. Our strategies are data-driven and
                    result-oriented, allowing you to confidently launch new products or services.
                  </p>
                </div>
              </div>
            </div>
