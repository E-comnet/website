        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-train-dev.png'}
                alt="dev image main"
                width={850}
                height={512}
              />
            ...
            <p>
              As businesses increasingly rely on technology to drive their operations, the demand for skilled FullStack developers
              and DevOps professionals continues to grow. These roles are critical in building and maintaining the software and systems that power modern businesses.
              However, staying competitive in this field requires continuous learning and adaptation.
            </p>
            <p>
              Ecomnet’s training in FullStack development and DevOps, certified by Coursera, provides you with the knowledge and skills needed to excel in
              these high-demand areas. Whether you’re looking to advance your career or enhance your team’s
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    Ecomnet provides training through Coursera’s industry-recognized certifications.
                    These credentials are highly respected across the tech world, ensuring that your team is equipped with globally relevant skills.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Our FullStack development and DevOps courses cover a wide range of tools and technologies,
                    ensuring that your team is well-versed in the latest industry trends and best practices.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Whether your team is looking to upskill or transition into more advanced roles, Ecomnet’s
                    training programs open up new career pathways and provide the skills needed for professional growth.
                  </p>
                </div>
              </div>
            </div>
