        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-train-man.png'}
                alt="management image main"
                width={850}
                height={512}
              />
            ...
            <p>
              Effective project management is at the heart of any successful business initiative. It ensures that projects are completed on time,
              within budget, and to the highest standards. However, without the proper skills and knowledge, managing complex projects can be
              overwhelming. Ecomnet’s training in project management,
              based on PMI methodology, provides your team with the tools and techniques needed to navigate these challenges successfully.
            </p>
            <p>
              In addition to managing projects, securing the necessary funds to support business growth is crucial. Fundraising can be a daunting
              task, but with the right training, your team can learn how to identify potential funding sources,
            ...
            <div className="mt-2.5">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    Our project management and fundraising courses are led by industry experts with years of experience in their respective fields.
                    You’ll gain practical knowledge that can be applied immediately to real-world business challenges.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Ecomnet’s training programs are based on the internationally recognized PMI methodology, ensuring that your team learns
                    industry-standard project management techniques that deliver consistent results.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Our training doesn’t just focus on immediate project execution but also on long-term growth. We equip your team with the
                    tools and strategies needed to drive business expansion and secure the funding necessary to support that growth.
                  </p>
                </div>
              </div>
            </div>
