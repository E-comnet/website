        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-train-sales.png'}
                alt="sales image main"
                width={850}
                height={512}
              />
            ...
            <p>
              In the digital age, the ability to effectively market and sell your products or services is more critical than ever.
              However, the landscape is constantly changing, and businesses need to stay up-to-date with the latest strategies and
              tools to remain competitive. Ecomnet’s training in sales and digital marketing, utilizing the HubSpot platform, provides your team
              with the knowledge and skills needed to attract, engage, and convert customers.
            </p>
            <p>
              With the right training, your business can optimize its marketing efforts, streamline sales processes,
              and ultimately increase revenue. Whether you’re looking to improve lead generation, enhance customer engagement,
              or boost sales performance, our training programs are designed to help you achieve your goals.
            </p>
            ...
            <div className="mt-2.5">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    As a HubSpot-certified partner, Ecomnet brings advanced sales and marketing automation tools to your business.
                    Our training ensures that your team leverages the full power of HubSpot to generate leads, engage customers, and close deals.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    No two businesses are alike, and neither are their training needs. Ecomnet tailors its programs to your specific goals,
                    ensuring that your team learns techniques directly applicable to your business context.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    The end goal of our training is to enhance your sales and marketing performance. By focusing on key metrics like conversion rates, customer
                    engagement, and revenue growth, we ensure that your business sees real, measurable results.
                  </p>
                </div>
              </div>
            </div>
